# Summary (Hinglish / simple companions)

**Yeh `SUMMARY` official book jaisa same structure follow karta hai**—har link isi folder (`contrib-notes/book-hinglish/src/`) ke companion `.md` par jaata hai. Official English text hamesha repo ke [`docs/book/src/`](../../../../docs/book/src/) mein.
